...
class Kinetics(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        for i_try in range(self._num_retries):
            ...
            #     GrayList += [torch.tensor(img)]
            # frames =  torch.stack(GrayList,0).unsqueeze(3)
            # self.cfg.DATA.MEAN = [0.45]
            # self.cfg.DATA.STD = [0.225]
            ...
            if self.aug:
                if self.cfg.AUG.NUM_SAMPLE > 1:
                    ...
                    return frame_list, imgType,label_list, index_list, {}
            ...
            return frames,imgType, label, index, {}
        else:
            raise RuntimeError(
